# Proyecto DAW: Soluciones Tecnológicas para el Control Horario en Empresas
...
```
cd existing_repo
git remote add origin https://gitlab.com/iesaglinformatica/pfc/ddaw/2324_alvaroabascal.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/iesaglinformatica/pfc/ddaw/2324_alvaroabascal/-/settings/integrations)
